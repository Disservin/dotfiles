...
return {
  ...
  },
  {
    ...
    keys = {
      ...
      {
        "<leader>sw",
        ":lua require('telescope-live-grep-args.shortcuts').grep_word_under_cursor",
      ...
      -- {
      --   "<leader>sw",
      --   ":lua require('telescope-live-grep-args.shortcuts').grep_visual_selection",
      --   mode = "v",
      --   desc = "Selection +args (root dir)",
      -- },
      -- {
      --   "<leader>sW",
      --   ":lua require('telescope-live-grep-args.shortcuts').grep_visual_selection({cwd = false})",
      --   mode = "v",
